...
local ChangeLogData = {
	"Changes:",
	"• Add WowHead Links '#23'",
	"• Add localization for german chat tabs/channel names",
	"• Fix Priest color issue",
	"• Fix Shamans showing pink in tooltip",
	"• Fix calls from old classcolor function",
	"• Fix conflict with adibags",
	"• Fix error in yClassColors",
	"• Fix nil error from commit 'fd6f519'",
	"• Fixed AutoLootConfirm",
	"• Fixed PvPEmote module",
	"• Released 'v1.05'",
	"• Remove threat until a better solution appears",
	"• Update Locales",
