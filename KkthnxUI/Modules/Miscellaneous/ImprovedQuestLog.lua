...
function Module:SetupImprovedQuestLog()
	...
	local function SetTexProperties(which, region)
		if which == "TopLeft" then
			region:SetTexCoord(0.25, 0.5, 0, 0.5)
		elseif which == "TopMiddle" then
			region:SetTexCoord(0.5, 0.75, 0, 0.5)
		elseif which == "TopRight" then
			region:SetTexCoord(0.75, 1, 0, 0.5)
		elseif which == "BotLeft" then
			region:SetTexCoord(0.25, 0.5, 0.5, 1)
		elseif which == "BotMiddle" then
			region:SetTexCoord(0.5, 0.75, 0.5, 1)
		elseif which == "BotRight" then
			region:SetTexCoord(0.75, 1, 0.5, 1)
		end
	end
	...
	local textures = {
		TopLeft = "Interface\\AddOns\\KkthnxUI\\Media\\Textures\\Leatrix_Plus.blp",
		TopMiddle = "Interface\\AddOns\\KkthnxUI\\Media\\Textures\\Leatrix_Plus.blp",
		TopRight = "Interface\\AddOns\\KkthnxUI\\Media\\Textures\\Leatrix_Plus.blp",
		BotLeft = "Interface\\AddOns\\KkthnxUI\\Media\\Textures\\Leatrix_Plus.blp",
		BotMiddle = "Interface\\AddOns\\KkthnxUI\\Media\\Textures\\Leatrix_Plus.blp",
		BotRight = "Interface\\AddOns\\KkthnxUI\\Media\\Textures\\Leatrix_Plus.blp"
    }
