...
K.RaidBuffsTracking = {
	PRIEST = {
		{1243, "TOPLEFT", {1, 1, 0.66}, true}, -- Power Word: Fortitude (Rank 1)
		{1244, "TOPLEFT", {1, 1, 0.66}, true}, -- Power Word: Fortitude (Rank 2)
		{1245, "TOPLEFT", {1, 1, 0.66}, true}, -- Power Word: Fortitude (Rank 3)
		{2791, "TOPLEFT", {1, 1, 0.66}, true}, -- Power Word: Fortitude (Rank 4)
		{10937, "TOPLEFT", {1, 1, 0.66}, true}, -- Power Word: Fortitude (Rank 5)
		{10938, "TOPLEFT", {1, 1, 0.66}, true}, -- Power Word: Fortitude (Rank 6)
		{21562, "TOPLEFT", {1, 1, 0.66}, true}, -- Prayer of Fortitude (Rank 1)
		{21564, "TOPLEFT", {1, 1, 0.66}, true}, -- Prayer of Fortitude (Rank 2)
		{14752, "TOPRIGHT", {0.2, 0.7, 0.2}, true}, -- Divine Spirit (Rank 1)
		{14818, "TOPRIGHT", {0.2, 0.7, 0.2}, true}, -- Divine Spirit (Rank 2)
		{14819, "TOPRIGHT", {0.2, 0.7, 0.2}, true}, -- Divine Spirit (Rank 3)
		{27841, "TOPRIGHT", {0.2, 0.7, 0.2}, true}, -- Divine Spirit (Rank 4)
		{27581, "TOPRIGHT", {0.2, 0.7, 0.2}, true}, -- Prayer of Spirit (Rank 1)
		{976, "BOTTOMLEFT", {0.7, 0.7, 0.7}, true}, -- Shadow Protection (Rank 1)
		{10957, "BOTTOMLEFT", {0.7, 0.7, 0.7}, true}, -- Shadow Protection (Rank 2)
		{10958, "BOTTOMLEFT", {0.7, 0.7, 0.7}, true}, -- Shadow Protection (Rank 3)
		{27683, "BOTTOMLEFT", {0.7, 0.7, 0.7}, true}, -- Prayer of Shadow Protection (Rank 1)
		{17, "BOTTOM", {0.00, 0.00, 1.00}}, -- Power Word: Shield (Rank 1)
		{592, "BOTTOM", {0.00, 0.00, 1.00}}, -- Power Word: Shield (Rank 2)
		{600, "BOTTOM", {0.00, 0.00, 1.00}}, -- Power Word: Shield (Rank 3), true
	...
	DRUID = {
		{1126, "TOPLEFT", {0.2, 0.8, 0.8}, true}, -- Mark of the Wild (Rank 1)
		{5232, "TOPLEFT", {0.2, 0.8, 0.8}, true}, -- Mark of the Wild (Rank 2)
		{6756, "TOPLEFT", {0.2, 0.8, 0.8}, true}, -- Mark of the Wild (Rank 3)
		{5234, "TOPLEFT", {0.2, 0.8, 0.8}, true}, -- Mark of the Wild (Rank 4)
		{8907, "TOPLEFT", {0.2, 0.8, 0.8}, true}, -- Mark of the Wild (Rank 5)
		{9884, "TOPLEFT", {0.2, 0.8, 0.8}, true}, -- Mark of the Wild (Rank 6)
		{16878, "TOPLEFT", {0.2, 0.8, 0.8}, true}, -- Mark of the Wild (Rank 7)
		{21849, "TOPLEFT", {0.2, 0.8, 0.8}, true}, -- Gift of the Wild (Rank 1)
		{21850, "TOPLEFT", {0.2, 0.8, 0.8}, true}, -- Gift of the Wild (Rank 2)
		{467, "TOPRIGHT", {0.4, 0.2, 0.8}, true}, -- Thorns (Rank 1)
		{782, "TOPRIGHT", {0.4, 0.2, 0.8}, true}, -- Thorns (Rank 2)
		{1075, "TOPRIGHT", {0.4, 0.2, 0.8}, true}, -- Thorns (Rank 3)
		{8914, "TOPRIGHT", {0.4, 0.2, 0.8}, true}, -- Thorns (Rank 4)
		{9756, "TOPRIGHT", {0.4, 0.2, 0.8}, true}, -- Thorns (Rank 5)
		{9910, "TOPRIGHT", {0.4, 0.2, 0.8}, true}, -- Thorns (Rank 6)
	...
	PALADIN = {
		...
		{19836, "TOPLEFT", {0.2, 0.8, 0.2}, true}, -- Blessing of Might (Rank 4)
		{19837, "TOPLEFT", {0.2, 0.8, 0.2}, true}, -- Blessing of Might (Rank 5)
		{19838, "TOPLEFT", {0.2, 0.8, 0.2}, true}, -- Blessing of Might (Rank 6)
		{25291, "TOPLEFT", {0.2, 0.8, 0.2}, true}, -- Blessing of Might (Rank 7)
		{19742, "TOPLEFT", {0.2, 0.8, 0.2}, true}, -- Blessing of Wisdom (Rank 1)
		{19850, "TOPLEFT", {0.2, 0.8, 0.2}, true}, -- Blessing of Wisdom (Rank 2)
		{19852, "TOPLEFT", {0.2, 0.8, 0.2}, true}, -- Blessing of Wisdom (Rank 3)
		{19853, "TOPLEFT", {0.2, 0.8, 0.2}, true}, -- Blessing of Wisdom (Rank 4)
		{19854, "TOPLEFT", {0.2, 0.8, 0.2}, true}, -- Blessing of Wisdom (Rank 5)
		{25290, "TOPLEFT", {0.2, 0.8, 0.2}, true}, -- Blessing of Wisdom (Rank 6)
		{25782, "TOPLEFT", {0.2, 0.8, 0.2}, true}, -- Greater Blessing of Might (Rank 1)
		{25916, "TOPLEFT", {0.2, 0.8, 0.2}, true}, -- Greater Blessing of Might (Rank 2)
		{25894, "TOPLEFT", {0.2, 0.8, 0.2}, true}, -- Greater Blessing of Wisdom (Rank 1)
		{25918, "TOPLEFT", {0.2, 0.8, 0.2}, true}, -- Greater Blessing of Wisdom (Rank 2)
		{465, "BOTTOMLEFT", {0.58, 1.00, 0.50}}, -- Devotion Aura (Rank 1)
		{10290, "BOTTOMLEFT", {0.58, 1.00, 0.50}}, -- Devotion Aura (Rank 2)
		{643, "BOTTOMLEFT", {0.58, 1.00, 0.50}}, -- Devotion Aura (Rank 3)
		{10291, "BOTTOMLEFT", {0.58, 1.00, 0.50}}, -- Devotion Aura (Rank 4)
		{1032, "BOTTOMLEFT", {0.58, 1.00, 0.50}}, -- Devotion Aura (Rank 5)
		{10292, "BOTTOMLEFT", {0.58, 1.00, 0.50}}, -- Devotion Aura (Rank 6)
		{10293, "BOTTOMLEFT", {0.58, 1.00, 0.50}}, -- Devotion Aura (Rank 7)
		{19977, "BOTTOMRIGHT", {0.17, 1.00, 0.75}, true}, -- Blessing of Light (Rank 1)
		{19978, "BOTTOMRIGHT", {0.17, 1.00, 0.75}, true}, -- Blessing of Light (Rank 2)
		{19979, "BOTTOMRIGHT", {0.17, 1.00, 0.75}, true}, -- Blessing of Light (Rank 3)
		{1022, "TOPRIGHT", {0.17, 1.00, 0.75}, true}, -- Blessing of Protection (Rank 1)
		{5599, "TOPRIGHT", {0.17, 1.00, 0.75}, true}, -- Blessing of Protection (Rank 2)
		{10278, "TOPRIGHT", {0.17, 1.00, 0.75}, true}, -- Blessing of Protection (Rank 3)
		{19746, "BOTTOMLEFT", {0.83, 1.00, 0.07}}, -- Concentration Aura
	},
	SHAMAN = {
		...
		{8072, "BOTTOMRIGHT", {0.00, 0.00, 0.26}}, -- Stoneskin Totem (Rank 1)
		{8156, "BOTTOMRIGHT", {0.00, 0.00, 0.26}}, -- Stoneskin Totem (Rank 2)
		{8157, "BOTTOMRIGHT", {0.00, 0.00, 0.26}}, -- Stoneskin Totem (Rank 3)
		{10403, "BOTTOMRIGHT", {0.00, 0.00, 0.26}}, -- Stoneskin Totem (Rank 4)
		{10404, "BOTTOMRIGHT", {0.00, 0.00, 0.26}}, -- Stoneskin Totem (Rank 5)
		{10405, "BOTTOMRIGHT", {0.00, 0.00, 0.26}}, -- Stoneskin Totem (Rank 6)
	},
	WARRIOR = {
		{6673, "TOPLEFT", {0.2, 0.2, 1}, true}, -- Battle Shout (Rank 1)
		{5242, "TOPLEFT", {0.2, 0.2, 1}, true}, -- Battle Shout (Rank 2)
		{6192, "TOPLEFT", {0.2, 0.2, 1}, true}, -- Battle Shout (Rank 3)
		{11549, "TOPLEFT", {0.2, 0.2, 1}, true}, -- Battle Shout (Rank 4)
		{11550, "TOPLEFT", {0.2, 0.2, 1}, true}, -- Battle Shout (Rank 5)
		{11551, "TOPLEFT", {0.2, 0.2, 1}, true}, -- Battle Shout (Rank 6)
		{25289, "TOPLEFT", {0.2, 0.2, 1}, true}, -- Battle Shout (Rank 7)
	},
	MAGE = {
		{1459, "TOPLEFT", {0.89, 0.09, 0.05}, true}, -- Arcane Intellect (Rank 1)
		{1460, "TOPLEFT", {0.89, 0.09, 0.05}, true}, -- Arcane Intellect (Rank 2)
		{1461, "TOPLEFT", {0.89, 0.09, 0.05}, true}, -- Arcane Intellect (Rank 3)
		{10156, "TOPLEFT", {0.89, 0.09, 0.05}, true}, -- Arcane Intellect (Rank 4)
		{10157, "TOPLEFT", {0.89, 0.09, 0.05}, true}, -- Arcane Intellect (Rank 5)
		{23028, "TOPLEFT", {0.89, 0.09, 0.05}, true}, -- Arcane Brilliance (Rank 1)
		{604, "TOPRIGHT", {0.2, 0.8, 0.2}, true}, -- Dampen Magic (Rank 1)
		{8450, "TOPRIGHT", {0.2, 0.8, 0.2}, true}, -- Dampen Magic (Rank 2)
		{8451, "TOPRIGHT", {0.2, 0.8, 0.2}, true}, -- Dampen Magic (Rank 3)
		{10173, "TOPRIGHT", {0.2, 0.8, 0.2}, true}, -- Dampen Magic (Rank 4)
		{10174, "TOPRIGHT", {0.2, 0.8, 0.2}, true}, -- Dampen Magic (Rank 5)
		{1008, "TOPRIGHT", {0.2, 0.8, 0.2}, true}, -- Amplify Magic (Rank 1)
	...
	WARLOCK = {
		{5597, "TOPLEFT", {0.89, 0.09, 0.05}, true}, -- Unending Breath
		{6512, "TOPRIGHT", {0.2, 0.8, 0.2}, true}, -- Detect Lesser Invisibility
		{2970, "TOPRIGHT", {0.2, 0.8, 0.2}, true}, -- Detect Invisibility
		{11743, "TOPRIGHT", {0.2, 0.8, 0.2}, true}, -- Detect Greater Invisibility
	},
	PET = {
		-- Warlock Imp
		...
		-- Hunter Pets
		{24604, "TOPRIGHT", {0.08, 0.59, 0.41}}, -- Furious Howl (Rank 1)
