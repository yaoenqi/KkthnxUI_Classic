...
_G.KkthnxUIConfig["ruRU"] = {
	...
	["Inventory"] = {
		...
		["BagColumns"] = {
			["Name"] = "Количество столбцов в сумках",
		},

		["BankColumns"] = {
			["Name"] = "Количество столбцов в банке",
		},
		...
		["ButtonSpace"] = {
			["Name"] = "Промежуток между ячейками",
		},

		["DetailedReport"] = {
			["Name"] = "Отчёт о продаже серых вещей",
			["Desc"] = "Пишет в чат на какую сумму было всё продано.",
		},
		...
		["JunkIcon"] = {
			["Name"] = "Показывать иконку мусора",
			["Desc"] = "Показывает иконку на серых бесполезных предметах, которые могут быть проданы.",
		},

		["PulseNewItem"] = {
			["Name"] = "Свечение на новых предметах",
		},
